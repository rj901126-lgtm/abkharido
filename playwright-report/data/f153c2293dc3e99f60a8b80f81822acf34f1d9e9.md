...
- Name: auth.spec.js >> Authentication Flow >> should login with OTP using developer test number
      ...
      - generic:
        - generic:
          - generic:
            ...
            - text: in
            - strong: Kolkata
        - generic: Bought L'Oreal Professionnel Serie Expert Shampoo (1500 ml)
        - generic: Verified • 54m ago
